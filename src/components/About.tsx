	...
	return (
		<section id='about' aria-labelledby='about-me-heading'>
			...
			<p className='text-zinc-700 dark:text-gray-300'>
				Hey there! I’m a frontend UI developer at Cisco, building React and TypeScript interfaces
				for enterprise security products. I love clean, thoughtful UI work, especially accessible
				interactions, maintainable component systems, reliable tests, and the tiny design choices
				that make an interface feel easier to use. I’m also equally curious about the UX side, like
				digging into design decisions, sitting in on user interviews, and exploring tools like
				Google Analytics to see what’s clicking (and what’s not 🤭).
			</p>
			<p className='mt-3 text-zinc-700 dark:text-gray-300'>
				Outside of work, you’ll usually find me crocheting something cute, baking, vibing at a
				concert, getting lost in a video game, reading a spine-chilling murder mystery, or planning
				my next adventure. I also love finding cozy cafés and hidden gems wherever I go. I care
				about the little details, whether it’s a button hover state or a perfectly golden cookie!
			</p>
			<img
